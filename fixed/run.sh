...
docker run --privileged --name asg2 -v .:/workspace -it sshs_asg2 sh -c "
	...
	./js_asan in/crashes/id:000000,sig:11,src:000001,time:48164,execs:159600,op:havoc,rep:2 ;
	echo 'Running patched program with input crashes/id:000000...' &&
	./js-patched_asan in/crashes/id:000000,sig:11,src:000001,time:48164,execs:159600,op:havoc,rep:2
"
